...
def test_bankaccountentry_create():
    ...
    BankAccountEntry.objects.create(bankaccount=ba1, date=["2020-01-01", "2020-01-31"], balance="100")

    # 2nd entry with non-overlapping date should work
    BankAccountEntry.objects.create(bankaccount=ba1, date=["2020-02-01", "2020-02-28"], balance="100")

    # entry with overlapping date within other bank account should work
    ba2 = BankAccount.objects.create(name="ba2")
    BankAccountEntry.objects.create(bankaccount=ba2, date=["2020-01-01", "2020-01-31"], balance="100")
...
def test_bankaccountentry_sum_balance():
    ...
    """
    ba1 = BankAccount.objects.create(name="ba1")
    BankAccountEntry.objects.create(bankaccount=ba1, date=["2020-01-01", "2020-02-01"], balance="100")
    BankAccountEntry.objects.create(bankaccount=ba1, date=["2020-02-01", "2020-03-01"], balance="200")
    ...
    # with a second BankAccount
    ba2 = BankAccount.objects.create(name="ba2")
    BankAccountEntry.objects.create(bankaccount=ba2, date=["2020-01-01", "2020-01-31"], balance="30")
...
def test_bankaccountentry_sum_balance_by_month():
    ...
    BankAccountEntry.objects.create(bankaccount=ba1, date=["2020-01-01", "2020-02-01"], balance="100")
    BankAccountEntry.objects.create(bankaccount=ba1, date=["2020-02-01", "2020-03-01"], balance="200")
    BankAccountEntry.objects.create(bankaccount=ba1, date=["2020-03-01", "2020-04-01"], balance="300")
