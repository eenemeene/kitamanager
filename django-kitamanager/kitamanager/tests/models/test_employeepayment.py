...
def test_employeepaymenttable_create():
    ...
    EmployeePaymentTable.objects.create(plan=p1, start="2020-01-01", end="2020-12-31")
    EmployeePaymentTable.objects.create(plan=p1, start="2021-01-01", end="2021-12-31")

    # same tables, but for the other plan should work
    EmployeePaymentTable.objects.create(plan=p2, start="2020-01-01", end="2020-12-31")
    EmployeePaymentTable.objects.create(plan=p2, start="2021-01-01", end="2021-12-31")

    # overlapping date should not work
    with pytest.raises(IntegrityError):
        EmployeePaymentTable.objects.create(plan=p2, start="2021-06-01", end="2023-12-31")
...
def test_employeepaymenttableentry_create():
    ...
    t11 = EmployeePaymentTable.objects.create(plan=p1, start="2020-01-01", end="2020-12-31")
    t12 = EmployeePaymentTable.objects.create(plan=p1, start="2021-01-01", end="2021-12-31")

    # same tables, but for the other plan should work
    t21 = EmployeePaymentTable.objects.create(plan=p2, start="2020-01-01", end="2020-12-31")
    t22 = EmployeePaymentTable.objects.create(plan=p2, start="2021-01-01", end="2021-12-31")
