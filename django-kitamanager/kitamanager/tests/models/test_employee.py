...
def test_employee_begin_date():
    ...
    _employeecontract_create(e, date=["2010-01-01", "2012-12-31"])
...
def test_employee_salary():
    ...
    assert e1.salary(parse("2020-01-01").date()) == None

    # a payment plan
    plan100 = EmployeePaymentPlan.objects.create(name="plan100")
    table100 = EmployeePaymentTable.objects.create(plan=plan100, hours=39, date=["2020-01-01", "2020-12-31"])
    ...
    assert e1.salary(parse("2022-01-01").date()) == None
